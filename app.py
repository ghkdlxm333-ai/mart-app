...
st.set_page_config(page_title="홈플러스 수주 자동화 (최종 매칭)", layout="wide")
...
st.title("🛒 홈플러스 수주 자동화 (VLOOKUP 로직 완성)")
